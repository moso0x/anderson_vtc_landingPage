...
const ActivityCard = ({ title, description, icon, category }) => (
  <div className="relative rounded-xl shadow-lg p-6 bg-black/30 border border-white/20 backdrop-blur-md hover:shadow-2xl transition duration-300 transform hover:scale-105 text-white">
    ...
    <p className="text-sm mb-3 text-white/90">{description}</p>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <h2 className="text-4xl font-extrabold text-cyan-400 mb-6 text-center drop-shadow-xl">
